...
import br.pucpr.table.PlanetTableData;
import br.pucpr.table.Table;
import br.pucpr.table.UserTableData;
...
public class Main {
  public static void main(String[] args) {
    ...
    System.out.println("-------------------");
    new Table(new UserTableData(usuarios, true)).print(LIGHT, true);
    ...
    System.out.println("-------------------");
    new Table(new PlanetTableData(planetas)).print(Theme.NORMAL, false);
  }
}